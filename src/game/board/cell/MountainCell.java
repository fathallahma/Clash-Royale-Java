...
public class MountainCell extends Cell{
	...
	public String toString(){
		return "MountainCell(" + this.numRow + "," + this.numColumn + ")"; 
		//exmeple : MountainCell(4,5)
	}
	public void print() {
		System.out.print("M");
	}
